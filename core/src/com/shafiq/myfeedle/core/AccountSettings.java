...
public class AccountSettings extends Activity implements View.OnClickListener {
	private int mMessages_bg_color_value = Myfeedle.default_message_bg_color,
	...
	private boolean mTime24hr_value = Myfeedle.default_time24hr,
	...
	private long mAccountId = Myfeedle.INVALID_ACCOUNT_ID;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (i.hasExtra(Myfeedle.EXTRA_ACCOUNT_ID))
			mAccountId = i.getLongExtra(Myfeedle.EXTRA_ACCOUNT_ID, Myfeedle.INVALID_ACCOUNT_ID);
		...
		if (!c.moveToFirst()) {
			...
			if (!c.moveToFirst()) {
				...
				if (!c.moveToFirst())
					mWidgetAccountSettingsId = initAccountSettings(this, AppWidgetManager.INVALID_APPWIDGET_ID, Myfeedle.INVALID_ACCOUNT_ID);
				if (mAppWidgetId != AppWidgetManager.INVALID_APPWIDGET_ID)
					mWidgetAccountSettingsId = initAccountSettings(this, mAppWidgetId, Myfeedle.INVALID_ACCOUNT_ID);
			}
