...
public class MyfeedleOAuth {

	private OAuthConsumer mOAuthConsumer;
	private OAuthProvider mOAuthProvider;
	private static final String TAG = "MyfeedleOAuth";

	public MyfeedleOAuth(String apiKey, String apiSecret) {
		Log.d(TAG, "creating MyfeedleOAuth");
		mOAuthConsumer = new CommonsHttpOAuthConsumer(apiKey, apiSecret);
		mOAuthConsumer.setMessageSigner(new HmacSha1MessageSigner());
	}

	public MyfeedleOAuth(String apiKey, String apiSecret, String token, String tokenSecret) {
		mOAuthConsumer = new CommonsHttpOAuthConsumer(apiKey, apiSecret);
		mOAuthConsumer.setMessageSigner(new HmacSha1MessageSigner());
