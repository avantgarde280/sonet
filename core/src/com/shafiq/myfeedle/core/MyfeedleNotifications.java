...
import static com.shafiq.myfeedle.core.Myfeedle.FACEBOOK_HOME;
...
import static com.shafiq.myfeedle.core.Myfeedle.FOURSQUARE_CHECKINS;
...
import static com.shafiq.myfeedle.core.Myfeedle.GOOGLEPLUS_ACTIVITIES;
...
import static com.shafiq.myfeedle.core.Myfeedle.GOOGLEPLUS_DATE_FORMAT;
...
import static com.shafiq.myfeedle.core.Myfeedle.LINKEDIN_UPDATES;
import static com.shafiq.myfeedle.core.Myfeedle.LINKEDIN_UPDATE_COMMENTS;
import static com.shafiq.myfeedle.core.Myfeedle.LinkedIn_UpdateTypes;
...
import static com.shafiq.myfeedle.core.Myfeedle.MYSPACE_HISTORY;
...
import static com.shafiq.myfeedle.core.Myfeedle.Sactor;
...
import static com.shafiq.myfeedle.core.Myfeedle.Sconnections;
import static com.shafiq.myfeedle.core.Myfeedle.Scontent;
import static com.shafiq.myfeedle.core.Myfeedle.ScreatedAt;
import static com.shafiq.myfeedle.core.Myfeedle.Screated_time;
import static com.shafiq.myfeedle.core.Myfeedle.ScurrentShare;
...
import static com.shafiq.myfeedle.core.Myfeedle.Sjob;
import static com.shafiq.myfeedle.core.Myfeedle.SlastName;
import static com.shafiq.myfeedle.core.Myfeedle.Slink;
import static com.shafiq.myfeedle.core.Myfeedle.SmemberGroups;
...
import static com.shafiq.myfeedle.core.Myfeedle.SoriginalContent;
import static com.shafiq.myfeedle.core.Myfeedle.Sperson;
import static com.shafiq.myfeedle.core.Myfeedle.SpersonActivities;
import static com.shafiq.myfeedle.core.Myfeedle.Sposition;
import static com.shafiq.myfeedle.core.Myfeedle.SpostedDate;
import static com.shafiq.myfeedle.core.Myfeedle.Spublished;
import static com.shafiq.myfeedle.core.Myfeedle.Srecent;
import static com.shafiq.myfeedle.core.Myfeedle.SrecentComments;
import static com.shafiq.myfeedle.core.Myfeedle.SrecommendationSnippet;
import static com.shafiq.myfeedle.core.Myfeedle.SrecommendationsGiven;
import static com.shafiq.myfeedle.core.Myfeedle.Srecommendee;
import static com.shafiq.myfeedle.core.Myfeedle.Sreplies;
import static com.shafiq.myfeedle.core.Myfeedle.Sresponse;
import static com.shafiq.myfeedle.core.Myfeedle.Sshout;
import static com.shafiq.myfeedle.core.Myfeedle.Sstatus;
import static com.shafiq.myfeedle.core.Myfeedle.SstatusId;
import static com.shafiq.myfeedle.core.Myfeedle.Stimestamp;
import static com.shafiq.myfeedle.core.Myfeedle.Stitle;
import static com.shafiq.myfeedle.core.Myfeedle.Sto;
import static com.shafiq.myfeedle.core.Myfeedle.StotalItems;
import static com.shafiq.myfeedle.core.Myfeedle.Stype;
import static com.shafiq.myfeedle.core.Myfeedle.SupdateComments;
import static com.shafiq.myfeedle.core.Myfeedle.SupdateContent;
import static com.shafiq.myfeedle.core.Myfeedle.SupdateKey;
import static com.shafiq.myfeedle.core.Myfeedle.SupdateType;
...
import static com.shafiq.myfeedle.core.Myfeedle.Svenue;
...
public class MyfeedleNotifications extends ListActivity {
	...
	protected void onListItemClick(ListView list, final View view, int position, final long id) {
		...
		// load MyfeedleComments.java, the notification will be clear there
		startActivityForResult(Myfeedle.getPackageIntent(this, MyfeedleComments.class).setData(Uri.withAppendedPath(Notifications.getContentUri(this), Long.toString(id))), RESULT_REFRESH);
	}
		...
		if (item.getItemId() == CLEAR) {
			...
			final AsyncTask<Void, Void, Void> asyncTask = new AsyncTask<Void, Void, Void>() {
				...
				protected Void doInBackground(Void... arg0) {
					...
					MyfeedleNotifications.this.getContentResolver().update(Notifications.getContentUri(MyfeedleNotifications.this), values, Notifications._ID + "=?", new String[]{Long.toString(((AdapterContextMenuInfo) item.getMenuInfo()).id)});
					return null;
				}
		...
		final AsyncTask<Integer, String, Boolean> asyncTask = new AsyncTask<Integer, String, Boolean>() {
			...
			protected Boolean doInBackground(Integer... arg0) {
				if (arg0[0] == R.id.menu_notifications_refresh) {
					...
					Cursor widgets = getContentResolver().query(Widgets_settings.getDistinctContentUri(MyfeedleNotifications.this), new String[]{Widgets.ACCOUNT}, Widgets.ACCOUNT + "!=-1 and (" + Widgets.LIGHTS + "=1 or " + Widgets.VIBRATE + "=1 or " + Widgets.SOUND + "=1)", null, null);
					if (widgets.moveToFirst()) {
						...
						while (!widgets.isAfterLast()) {
							...
							Cursor account = getContentResolver().query(Accounts.getContentUri(MyfeedleNotifications.this), new String[]{Accounts.TOKEN, Accounts.SECRET, Accounts.SERVICE, Accounts.SID}, Accounts._ID + "=?", new String[]{Long.toString(accountId)}, null);
							if (account.moveToFirst()) {
								...
								if (service == TWITTER) {
									Cursor currentNotifications = getContentResolver().query(Notifications.getContentUri(MyfeedleNotifications.this), new String[]{Notifications.SID}, Notifications.ACCOUNT + "=?", new String[]{Long.toString(accountId)}, null);
									...
									Cursor last_status = getContentResolver().query(Statuses.getContentUri(MyfeedleNotifications.this), new String[]{Statuses.SID}, Statuses.ACCOUNT + "=?", new String[]{Long.toString(accountId)}, Statuses.CREATED + " ASC LIMIT 1");
									...
									String response = MyfeedleHttpClient.httpResponse(httpClient, myfeedleOAuth.getSignedRequest(new HttpGet(String.format(TWITTER_MENTIONS, TWITTER_BASE_URL, last_sid != null ? String.format(TWITTER_SINCE_ID, last_sid) : ""))));
									if (response != null) {
										try {
									...
									last_status.close();
									// get all mentions since the oldest status for this account
									String response = MyfeedleHttpClient.httpResponse(httpClient, myfeedleOAuth.getSignedRequest(new HttpGet(String.format(IDENTICA_MENTIONS, IDENTICA_BASE_URL, last_sid != null ? String.format(IDENTICA_SINCE_ID, last_sid) : ""))));
									if (response != null) {
										try {
											JSONArray comments = new JSONArray(response);
											for (int i = 0, i2 = comments.length(); i < i2; i++) {
									...
									Cursor currentNotifications = getContentResolver().query(Notifications.getContentUri(MyfeedleNotifications.this), new String[]{Notifications._ID, Notifications.SID, Notifications.UPDATED, Notifications.CLEARED, Notifications.ESID}, Notifications.ACCOUNT + "=?", new String[]{Long.toString(accountId)}, null);
									if (currentNotifications.moveToFirst()) {
										String response;
										...
										case FACEBOOK:
											...
											while (!currentNotifications.isAfterLast()) {
												...
												String sid = mMyfeedleCrypto.Decrypt(currentNotifications.getString(1));
														...
														if (i2 > 0) {
															for (int i = 0; i < i2; i++) {
																...
																if (created_time > updated) {
																	...
																	getContentResolver().update(Notifications.getContentUri(MyfeedleNotifications.this), values, Notifications._ID + "=?", new String[]{Long.toString(notificationId)});
																}
															}
														}
													} catch (JSONException e) {
											...
											break;
										case MYSPACE:
											myfeedleOAuth = new MyfeedleOAuth(MYSPACE_KEY, MYSPACE_SECRET, token, secret);
											// loop over notifications
											while (!currentNotifications.isAfterLast()) {
												long notificationId = currentNotifications.getLong(0);
												String sid = mMyfeedleCrypto.Decrypt(currentNotifications.getString(1));
												long updated = currentNotifications.getLong(2);
												boolean cleared = currentNotifications.getInt(3) == 1;
												String esid = mMyfeedleCrypto.Decrypt(currentNotifications.getString(4));
												// store sids, to avoid duplicates when requesting the latest feed
												if (!notificationSids.contains(sid)) {
													notificationSids.add(sid);
												}
										...
										case FOURSQUARE:
											...
											break;
										case LINKEDIN:
											myfeedleOAuth = new MyfeedleOAuth(LINKEDIN_KEY, LINKEDIN_SECRET, token, secret);
											// loop over notifications
											while (!currentNotifications.isAfterLast()) {
												long notificationId = currentNotifications.getLong(0);
												String sid = mMyfeedleCrypto.Decrypt(currentNotifications.getString(1));
											...
											try {
												...
												if ((response = MyfeedleHttpClient.httpResponse(httpClient, httpPost)) != null) {
													...
													if (j.has(Saccess_token)) {
														...
														// get new feed
														if ((response = MyfeedleHttpClient.httpResponse(httpClient, new HttpGet(String.format(GOOGLEPLUS_ACTIVITIES, GOOGLEPLUS_BASE_URL, "me", "public", 20, access_token)))) != null) {
								...
								getContentResolver().delete(Notifications.getContentUri(MyfeedleNotifications.this), Notifications.CLEARED + "=1 and " + Notifications.ACCOUNT + "=? and " + Notifications.CREATED + "<?", new String[]{Long.toString(accountId), Long.toString(System.currentTimeMillis() - 86400000)});
							}
							account.close();
							widgets.moveToNext();
						}
					...
					ContentValues values = new ContentValues();
					values.put(Notifications.CLEARED, 1);
					MyfeedleNotifications.this.getContentResolver().update(Notifications.getContentUri(MyfeedleNotifications.this), values, null, null);
					return true;
				}
				return false;
			}
	...
	protected void onResume() {
		...
		((NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE)).cancel(Myfeedle.NOTIFY_ID);
		loadNotifications();
	}
	...
	private void loadNotifications() {
		Cursor c = this.managedQuery(Notifications.getContentUri(MyfeedleNotifications.this), new String[]{Notifications._ID, Notifications.CLEARED, Notifications.NOTIFICATION}, Notifications.CLEARED + "!=1", null, null);
