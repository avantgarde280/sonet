...
public class MyfeedleUploader extends Service {
	private static final String TAG = "MyfeedleUploader";
	...
	public void onCreate() {
		...
		(new AsyncTask<Void, Void, Boolean>() {
			...
			protected Boolean doInBackground(Void... arg0) {
				...
				Cursor c = getContentResolver().query(Widgets.getContentUri(MyfeedleUploader.this), new String[]{Widgets._ID}, Widgets.INSTANT_UPLOAD + "=1", null, null);
						...
						public void onChange(boolean selfChange) {
							...
							(new AsyncTask<Void, Void, String>() {
								...
								protected void onPostExecute(String filepath) {
									...
									if (filepath != null)
										startActivity(Myfeedle.getPackageIntent(getApplicationContext(), StatusDialog.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP).putExtra(Widgets.INSTANT_UPLOAD, filepath));
								}
