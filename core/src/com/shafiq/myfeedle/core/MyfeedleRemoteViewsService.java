...
public class MyfeedleRemoteViewsService extends android.widget.RemoteViewsService {

	@Override
	public RemoteViewsFactory onGetViewFactory(Intent intent) {
		return new MyfeedleRemoteViewsFactory(this.getApplicationContext(), intent);
	}
