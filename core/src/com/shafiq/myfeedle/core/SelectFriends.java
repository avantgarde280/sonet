...
import static com.shafiq.myfeedle.core.Myfeedle.FACEBOOK_FRIENDS;
import static com.shafiq.myfeedle.core.Myfeedle.FACEBOOK_PICTURE;
		...
		final AsyncTask<Long, String, Boolean> asyncTask = new AsyncTask<Long, String, Boolean>() {
			...
			protected Boolean doInBackground(Long... params) {
				...
				case TWITTER:
					break;
				case FACEBOOK:
					if ((response = MyfeedleHttpClient.httpResponse(mHttpClient, new HttpGet(String.format(FACEBOOK_FRIENDS, FACEBOOK_BASE_URL, Saccess_token, mToken)))) != null) {
						try {
