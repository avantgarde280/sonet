...
import static com.shafiq.myfeedle.core.Myfeedle.initAccountSettings;

public class Settings extends Activity implements View.OnClickListener {
	private int mInterval_value = Myfeedle.default_interval,
			mButtons_bg_color_value = Myfeedle.default_buttons_bg_color,
			mButtons_color_value = Myfeedle.default_buttons_color,
			mButtons_textsize_value = Myfeedle.default_buttons_textsize,
			mMessages_bg_color_value = Myfeedle.default_message_bg_color,
			mMessages_color_value = Myfeedle.default_message_color,
			mMessages_textsize_value = Myfeedle.default_messages_textsize,
			mFriend_color_value = Myfeedle.default_friend_color,
			mFriend_textsize_value = Myfeedle.default_friend_textsize,
			mCreated_color_value = Myfeedle.default_created_color,
			mCreated_textsize_value = Myfeedle.default_created_textsize,
			mStatuses_per_account_value = Myfeedle.default_statuses_per_account,
			mMargin_value = Myfeedle.default_margin,
			mProfiles_bg_color_value = Myfeedle.default_message_bg_color,
			mFriend_bg_color_value = Myfeedle.default_friend_bg_color,
			mScrollable_version = 0;
	private boolean mHasButtons_value = Myfeedle.default_hasButtons,
			mTime24hr_value = Myfeedle.default_time24hr,
			mIcon_value = Myfeedle.default_hasIcon,
			mBackgroundUpdate_value = Myfeedle.default_backgroundUpdate,
			mSound_value = Myfeedle.default_sound,
			mVibrate_value = Myfeedle.default_vibrate,
			mLights_value = Myfeedle.default_lights,
			mDisplay_profile_value = Myfeedle.default_include_profile,
			mInstantUpload_value = Myfeedle.default_instantUpload;
