...
import com.shafiq.myfeedle.core.Myfeedle.Accounts_styles;
import com.shafiq.myfeedle.core.Myfeedle.Entities;
import com.shafiq.myfeedle.core.Myfeedle.Notifications;
import com.shafiq.myfeedle.core.Myfeedle.Status_images;
...
import com.shafiq.myfeedle.core.Myfeedle.Widget_accounts_view;
import com.shafiq.myfeedle.core.Myfeedle.Widgets;
import com.shafiq.myfeedle.core.Myfeedle.Widgets_settings;

import java.util.HashMap;

public class MyfeedleProvider extends ContentProvider {

	private static final String TAG = "MyfeedleProvider";

	public static final String AUTHORITY = "com.shafiq.myfeedle.MyfeedleProvider";
	public static final String PRO_AUTHORITY = "com.shafiq.myfeedlepro.MyfeedleProvider";
	...
	protected static final String DATABASE_NAME = "myfeedle.db";
	...
	public int delete(Uri uri, String whereClause, String[] whereArgs) {
		SQLiteDatabase db;
		synchronized (Myfeedle.sDatabaseLock) {
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		long rowId;
		Uri returnUri = null;
		MyfeedleCrypto myfeedleCrypto;
		switch (sUriMatcher.match(uri)) {
		case ACCOUNTS:
			// encrypt the data
			myfeedleCrypto = MyfeedleCrypto.getInstance(getContext());
			if (values.containsKey(Accounts.TOKEN))
				values.put(Accounts.TOKEN, myfeedleCrypto.Encrypt(values.getAsString(Accounts.TOKEN)));
			if (values.containsKey(Accounts.SECRET))
				values.put(Accounts.SECRET, myfeedleCrypto.Encrypt(values.getAsString(Accounts.SECRET)));
			if (values.containsKey(Accounts.SID))
				values.put(Accounts.SID, myfeedleCrypto.Encrypt(values.getAsString(Accounts.SID)));
			synchronized (Myfeedle.sDatabaseLock) {
		...
		case STATUSES:
			...
			if (values.containsKey(Statuses.SID))
				values.put(Statuses.SID, myfeedleCrypto.Encrypt(values.getAsString(Statuses.SID)));
			synchronized (Myfeedle.sDatabaseLock) {
		...
		case ENTITIES:
			...
			if (values.containsKey(Entities.ESID))
				values.put(Entities.ESID, myfeedleCrypto.Encrypt(values.getAsString(Entities.ESID)));
			synchronized (Myfeedle.sDatabaseLock) {
		...
		case NOTIFICATIONS:
			...
			if (values.containsKey(Notifications.SID))
				values.put(Notifications.SID, myfeedleCrypto.Encrypt(values.getAsString(Notifications.SID)));
			if (values.containsKey(Notifications.ESID))
				values.put(Notifications.ESID, myfeedleCrypto.Encrypt(values.getAsString(Notifications.ESID)));
			synchronized (Myfeedle.sDatabaseLock) {
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			...
			db.execSQL("create view if not exists " + VIEW_STATUSES_STYLES + " as select " +
					...
					+ " else " + Myfeedle.default_friend_color + " end) as " + Statuses_styles.FRIEND_COLOR
					...
					+ " else " + Myfeedle.default_created_color + " end) as " + Statuses_styles.CREATED_COLOR
					...
					+ " else " + Myfeedle.default_message_color + " end) as " + Statuses_styles.MESSAGES_COLOR
					...
					+ " else " + Myfeedle.default_messages_textsize + " end) as " + Statuses_styles.MESSAGES_TEXTSIZE
					...
					+ " else " + Myfeedle.default_friend_textsize + " end) as " + Statuses_styles.FRIEND_TEXTSIZE
					...
					+ " else " + Myfeedle.default_created_textsize + " end) as " + Statuses_styles.CREATED_TEXTSIZE
			...
			db.execSQL("create view if not exists " + VIEW_WIDGETS_SETTINGS + " as select a."
					...
					+ " else " + Myfeedle.default_interval + " end) as " + Widgets.INTERVAL
					...
					+ " else " + Myfeedle.default_buttons_bg_color + " end) as " + Widgets.BUTTONS_BG_COLOR
					...
					+ " else " + Myfeedle.default_buttons_color + " end) as " + Widgets.BUTTONS_COLOR
					+ ",(case when a." + Widgets.FRIEND_COLOR + " is not null then a." + Widgets.FRIEND_COLOR
					+ " when b." + Widgets.FRIEND_COLOR + " is not null then b. " + Widgets.FRIEND_COLOR
					+ " when c." + Widgets.FRIEND_COLOR + " is not null then c." + Widgets.FRIEND_COLOR
					+ " else " + Myfeedle.default_friend_color + " end) as " + Widgets.FRIEND_COLOR
					+ ",(case when a." + Widgets.CREATED_COLOR + " is not null then a." + Widgets.CREATED_COLOR
					+ " when b." + Widgets.CREATED_COLOR + " is not null then b. " + Widgets.CREATED_COLOR
					+ " when c." + Widgets.CREATED_COLOR + " is not null then c." + Widgets.CREATED_COLOR
					+ " else " + Myfeedle.default_created_color + " end) as " + Widgets.CREATED_COLOR
					...
					+ " else " + Myfeedle.default_message_bg_color + " end) as " + Widgets.MESSAGES_BG_COLOR
					+ ",(case when a." + Widgets.MESSAGES_COLOR + " is not null then a." + Widgets.MESSAGES_COLOR
					+ " when b." + Widgets.MESSAGES_COLOR + " is not null then b. " + Widgets.MESSAGES_COLOR
					+ " when c." + Widgets.MESSAGES_COLOR + " is not null then c." + Widgets.MESSAGES_COLOR
					+ " else " + Myfeedle.default_message_color + " end) as " + Widgets.MESSAGES_COLOR
					...
					+ " else " + Myfeedle.default_buttons_textsize + " end) as " + Widgets.BUTTONS_TEXTSIZE
					+ ",(case when a." + Widgets.MESSAGES_TEXTSIZE + " is not null then a." + Widgets.MESSAGES_TEXTSIZE
					+ " when b." + Widgets.MESSAGES_TEXTSIZE + " is not null then b. " + Widgets.MESSAGES_TEXTSIZE
					+ " when c." + Widgets.MESSAGES_TEXTSIZE + " is not null then c." + Widgets.MESSAGES_TEXTSIZE
					+ " else " + Myfeedle.default_messages_textsize + " end) as " + Widgets.MESSAGES_TEXTSIZE
					+ ",(case when a." + Widgets.FRIEND_TEXTSIZE + " is not null then a." + Widgets.FRIEND_TEXTSIZE
					+ " when b." + Widgets.FRIEND_TEXTSIZE + " is not null then b. " + Widgets.FRIEND_TEXTSIZE
					+ " when c." + Widgets.FRIEND_TEXTSIZE + " is not null then c." + Widgets.FRIEND_TEXTSIZE
					+ " else " + Myfeedle.default_friend_textsize + " end) as " + Widgets.FRIEND_TEXTSIZE
					+ ",(case when a." + Widgets.CREATED_TEXTSIZE + " is not null then a." + Widgets.CREATED_TEXTSIZE
					+ " when b." + Widgets.CREATED_TEXTSIZE + " is not null then b. " + Widgets.CREATED_TEXTSIZE
					+ " when c." + Widgets.CREATED_TEXTSIZE + " is not null then c." + Widgets.CREATED_TEXTSIZE
					+ " else " + Myfeedle.default_created_textsize + " end) as " + Widgets.CREATED_TEXTSIZE
					...
					+ " else " + Myfeedle.default_statuses_per_account + " end) as " + Widgets.STATUSES_PER_ACCOUNT
					...
					+ " else " + Myfeedle.default_message_bg_color + " end) as " + Widgets.PROFILES_BG_COLOR
					...
					+ " else " + Myfeedle.default_friend_bg_color + " end) as " + Widgets.FRIEND_BG_COLOR
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			if (oldVersion < 7) {
				...
				growTable(db, TABLE_WIDGETS, Widgets.ACCOUNT, "integer", Long.toString(Myfeedle.INVALID_ACCOUNT_ID), false);
				...
				db.execSQL("insert into " + TABLE_STATUSES
						...
						+ "createdText,"
						+ Statuses.WIDGET + ","
						+ Myfeedle.INVALID_ACCOUNT_ID + ",null from " + TABLE_STATUSES + "_bkp;");
				...
				db.execSQL("create view if not exists " + VIEW_STATUSES_STYLES + " as select " +
						...
						+ "(case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + "=" + TABLE_STATUSES + "." + Statuses.ACCOUNT + ") is null then "
						+ "case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + " is null) is null then "
						+ Myfeedle.default_created_color
						...
						+ "(case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + "=" + TABLE_STATUSES + "." + Statuses.ACCOUNT + ") is null then "
						+ "case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + " is null) is null then "
						+ Myfeedle.default_message_color
						...
						+ "(case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + "=" + TABLE_STATUSES + "." + Statuses.ACCOUNT + ") is null then "
						+ "case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + " is null) is null then "
						+ Myfeedle.default_messages_textsize
						...
						+ "(case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + "=" + TABLE_STATUSES + "." + Statuses.ACCOUNT + ") is null then "
						+ "case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + " is null) is null then "
						+ Myfeedle.default_friend_textsize
						...
						+ "(case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + "=" + TABLE_STATUSES + "." + Statuses.ACCOUNT + ") is null then "
						+ "case when (select " + Widgets._ID + " from " + TABLE_WIDGETS + " where " + TABLE_WIDGETS + "." + Widgets.WIDGET + "=" + TABLE_STATUSES + "." + Statuses.WIDGET + " and " + TABLE_WIDGETS + "." + Widgets.ACCOUNT + " is null) is null then "
						+ Myfeedle.default_created_textsize
			...
			if (oldVersion < 8) {
				...
				db.execSQL("create view if not exists " + VIEW_STATUSES_STYLES + " as select " +
						...
						+ " is null) else "	+ Myfeedle.default_friend_color + " end) as " + Statuses_styles.FRIEND_COLOR + ","
						...
						+ " is null) else "	+ Myfeedle.default_created_color + " end) as " + Statuses_styles.CREATED_COLOR + ","
						...
						+ " is null) else "	+ Myfeedle.default_message_color + " end) as " + Statuses_styles.MESSAGES_COLOR + ","
						...
						+ " is null) else "	+ Myfeedle.default_messages_textsize + " end) as " + Statuses_styles.MESSAGES_TEXTSIZE + ","
						...
						+ " is null) else "	+ Myfeedle.default_friend_textsize + " end) as " + Statuses_styles.FRIEND_TEXTSIZE + ","
						...
						+ " is null) else "	+ Myfeedle.default_created_textsize + " end) as " + Statuses_styles.CREATED_TEXTSIZE + ","
			...
			if (oldVersion < 11) {
				...
				growTable(db, TABLE_WIDGETS, Widgets.STATUSES_PER_ACCOUNT, "integer", Integer.toString(Myfeedle.default_statuses_per_account), false);
